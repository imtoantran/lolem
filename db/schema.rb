...
ActiveRecord::Schema.define(version: 20160422022035) do
  ...
  create_table "post_categorizations", force: :cascade do |t|
    ...
    t.string   "post_category_id", limit: 255
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
  end

  create_table "post_category_translations", force: :cascade do |t|
    t.integer  "post_category_id", limit: 4,     null: false
  ...
  add_index "post_category_translations", ["locale"], name: "index_post_category_translations_on_locale", using: :btree
  add_index "post_category_translations", ["post_category_id"], name: "index_post_category_translations_on_post_category_id", using: :btree
  ...
  create_table "services", force: :cascade do |t|
    ...
    t.float    "price_promotion", limit: 24
  ...
  add_index "services", ["permalink"], name: "index_services_on_permalink", using: :btree
